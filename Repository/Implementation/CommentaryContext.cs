...
{
    public class CommentaryContext : ICommentaryContext
    {
        ...
        public CommentaryContext(IConfiguration configuration)
        {
            _connectionString = configuration["ConnectionStrings:Commentary"];
